...
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ HinduBusiness tasteV2
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ Matribhumi tasteV2
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ Matribhumienglish tasteV2
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ Gizmodo tasteV2
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ Manipal tasteV2
spark-submit --class kiwi.Knitter --num-executors 8 ./Kiwi-1.0.0.jar _ ManipalEnglish tasteV2
ENDSSH
